    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, help_text='Статус, кторый может ввести пользователь, например: "У меня сегодня отличное настроение"', max_length=255, null=True, verbose_name='Пользовательский статус')),
